...
sleepReport <- function(data, srtemp) {
  ...
  # Add summary table
  addDataFrame(data$dex, sheets$Summary, startRow = 3, startColumn = 2, col.names = F, row.names = F)
  
  # Add data for figures
  addDataFrame(data$slf, sheets$Figures, startRow = 2, startColumn = 1, col.names = F, row.names = F, showNA = T)
  addDataFrame(data$slfC1, sheets$`Figures C1`, startRow = 2, startColumn = 1, col.names = F, row.names = F, showNA = T)
  addDataFrame(data$slfC2, sheets$`Figures C2`, startRow = 2, startColumn = 1, col.names = F, row.names = F, showNA = T)
